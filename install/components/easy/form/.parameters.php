...
$arEventTypeFields = array(
    0 => array(
        'LID' => 'ru',
        'EVENT_NAME' => 'EASY_FORM',
        'NAME' => Loc::getMessage('EASY_FORM_RU_NAME'),
        'DESCRIPTION' => Loc::getMessage('EASY_FORM_RU_DESCRIPTION'),
    ),
    1 => array(
        'LID' => 'en',
        'EVENT_NAME' => 'EASY_FORM',
...
if (($installSendTemplates) && ($arCurrentValues['ENABLE_SEND_MAIL'] != 'N')) {
    $arEventMessFields = array(
        0 => array(
            ...
            'EVENT_NAME' => 'EASY_FORM',
            'LID' => $arSiteId,
            'EMAIL_FROM' => Loc::getMessage('EASY_FORM_EMAIL_FROM'),
            'EMAIL_TO' => Loc::getMessage('EASY_FORM_EVEN_EMAIL_TO'),
            'BCC' => Loc::getMessage('EASY_FORM_EVEN_BCC'),
            'SUBJECT' => Loc::getMessage('EASY_FORM_SUBJECT'),
            'BODY_TYPE' => 'html',
            'MESSAGE' => Loc::getMessage('EASY_FORM_MESSAGE'),
        )
    );
...
$arFields = array(
    'TITLE' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_TITLE'),
        'TYPE' => 'text',
    ),

    'EMAIL' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_EMAIL'),
        'TYPE' => 'email',
    ),
    'PHONE' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_PHONE'),
        'TYPE' => 'tel',
    ),
    'MALE' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_MALE'),
        'TYPE' => 'radio',
        'DEFAULT_VALUE' => array(Loc::getMessage('EASY_FORM_FIELD_MALE_VAL_1'), Loc::getMessage('EASY_FORM_FIELD_MALE_VAL_2')),
    ),
    'BUDGET' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_BUDGET'),
        'TYPE' => 'select',
        'DEFAULT_VALUE' => array(Loc::getMessage('EASY_FORM_FIELD_BUDGET_VAL_1'), Loc::getMessage('EASY_FORM_FIELD_BUDGET_VAL_2')),
    ),
    'SERVICES' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_SERVICES'),
        'TYPE' => 'checkbox',
        'DEFAULT_VALUE' => array(Loc::getMessage('EASY_FORM_FIELD_SERVICES_VAL_1'), Loc::getMessage('EASY_FORM_FIELD_SERVICES_VAL_2')),
    ),
    'MESSAGE' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_MESSAGE'),
        'TYPE' => 'textarea',
    ),
    'DOCS' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_DOCS'),
        'TYPE' => 'file',
    ),
    'ACCEPT' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_ACCEPT'),
        'TYPE' => 'accept',
        'DEFAULT_VALUE' => Loc::getMessage('EASY_FORM_FIELD_ACCEPT_VAL'),
    ),
    'HIDDEN' => array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_HIDDEN'),
        'TYPE' => 'hidden',
    )
);
...
$arComponentParameters = array(
    'GROUPS' => array(
        'SUBMIT' => array(
            'NAME' => Loc::getMessage('EASY_FORM_GROUP_SUBMIT'),
            'SORT' => 200,
        ),
        'MAIL' => array(
            'NAME' => Loc::getMessage('EASY_FORM_GROUP_MAIL'),
            'SORT' => 300,
        ),
        'CAPTCHA' => array(
            'NAME' => Loc::getMessage('EASY_FORM_CAPTCHA'),
            'SORT' => 1350,
        ),
        'IBLOCK_WRITE' => array(
            'NAME' => Loc::getMessage('EASY_FORM_GROUP_WRITE_IB'),
            'SORT' => 450,
        ),
        'PERSONAL_DATA' => array(
            'NAME' => Loc::getMessage('EASY_FORM_GROUP_PERSONAL_DATA'),
            'SORT' => 1350,
        ),
        'JS_VALIDATE_SETTINGS' => array(
            'NAME' => Loc::getMessage('EASY_FORM_GROUPS_JS_VALIDATE_SETTINGS'),
            'SORT' => 1370,
        ),
        'JS_LIB_SETTINGS' => array(
            'NAME' => Loc::getMessage('EASY_FORM_GROUPS_JS_LIB_SETTINGS'),
            'SORT' => 1400,
        )
    ...
    'PARAMETERS' => array(
        'FORM_ID' => Array(
            'NAME' => Loc::getMessage('EASY_FORM_UNIQUE_FORM_ID'),
            'TYPE' => 'STRING',
            'DEFAULT' => 'FORM' . mt_rand(1, 10),
            'PARENT' => 'BASE',
        ),
        'FORM_NAME' => Array(
            'NAME' => Loc::getMessage('EASY_FORM_FORM_NAME'),
            'TYPE' => 'STRING',
            'DEFAULT' => Loc::getMessage('EASY_FORM_FORM_NAME_DEFAULT') . mt_rand(1, 10),
            'PARENT' => 'BASE',
        ),
        'WIDTH_FORM' => Array(
            'NAME' => Loc::getMessage('EASY_FORM_WIDTH_FORM'),
            'TYPE' => 'STRING',
            'DEFAULT' => '500px',
            'PARENT' => 'BASE',
        ),
        'DISPLAY_FIELDS' => array(
            'PARENT' => 'BASE',
            'NAME' => Loc::getMessage('EASY_FORM_DISPLAY_FIELDS'),
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'REFRESH' => 'Y',
        ...
        'REQUIRED_FIELDS' => Array(
            'NAME' => Loc::getMessage('EASY_FORM_REQUIRED_FIELDS'),
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'VALUES' => $curFields,
        ...
        'FORM_AUTOCOMPLETE' => array(
            'NAME' => Loc::getMessage('EASY_FORM_FORM_AUTOCOMPLETE'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'Y',
            'PARENT' => 'BASE',
        ),
        'HIDE_FIELD_NAME' => array(
            'NAME' => Loc::getMessage('EASY_FORM_HIDE_FIELD_NAME'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => '',
            'PARENT' => 'BASE',
        ),
        'HIDE_ASTERISK' => array(
            'NAME' => Loc::getMessage('EASY_FORM_HIDE_ASTERISK'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => '',
            'PARENT' => 'BASE',
        ),
        'FORM_SUBMIT_VALUE' => array(
            'NAME' => Loc::getMessage('EASY_FORM_FORM_SUBMIT_VALUE'),
            'TYPE' => 'STRING',
            'DEFAULT' => Loc::getMessage('EASY_FORM_FORM_SUBMIT_VALUE_DEFAULT'),
            'COLS' => 50,
            'PARENT' => 'BASE',
        ),
        'ENABLE_SEND_MAIL' => array(
            'NAME' => Loc::getMessage('EASY_FORM_ENABLE_SEND_MAIL'),
            'TYPE' => 'CHECKBOX',
            'REFRESH' => 'Y',
            'DEFAULT' => 'Y',
            'PARENT' => 'MAIL',
        ...
        'USE_CAPTCHA' => array(
            'NAME' => Loc::getMessage('EASY_FORM_USE_CAPTCHA'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'PARENT' => 'CAPTCHA',
            'REFRESH' => 'Y',
        ...
        'USE_IBLOCK_WRITE' => array(
            'NAME' => Loc::getMessage('EASY_FORM_USE_IBLOCK_WRITE'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'PARENT' => 'IBLOCK_WRITE',
            'REFRESH' => 'Y',
        ...
        'USE_JQUERY' => array(
            'NAME' => Loc::getMessage('EASY_FORM_INCLUDE_JQUERY'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'PARENT' => 'JS_LIB_SETTINGS',
        ),
        'USE_BOOTSRAP_CSS' => array(
            'NAME' => Loc::getMessage('EASY_FORM_USE_BOOTSRAP_CSS'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'Y',
            'PARENT' => 'JS_LIB_SETTINGS',
        ),
        'USE_BOOTSRAP_JS' => array(
            'NAME' => Loc::getMessage('EASY_FORM_USE_BOOTSRAP_JS'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'PARENT' => 'JS_LIB_SETTINGS',
        ),
...
if ($arCurrentValues['USE_FORMVALIDATION_JS'] != 'N') {
    $arComponentParameters['PARAMETERS']['HIDE_FORMVALIDATION_TEXT'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_HIDE_FORMVALIDATION_TEXT'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y',
        'PARENT' => 'JS_VALIDATE_SETTINGS',
    ...
    $arComponentParameters['PARAMETERS']['INCLUDE_BOOTSRAP_JS'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_INCLUDE_FORMVALIDATION_LIBS'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y',
        'REFRESH' => 'N',
        'PARENT' => 'JS_VALIDATE_SETTINGS',
...
$includeModuleEasyForm = Loader::includeModule("easy.form");
if ($includeModuleEasyForm) {
    $arComponentParameters['PARAMETERS']['USE_MODULE_VARNING'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_USE_MODULE_VARNING'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y',
        'REFRESH' => 'Y',
...
if ($arCurrentValues['USE_MODULE_VARNING'] != 'Y' || !$includeModuleEasyForm) {
    $arComponentParameters['PARAMETERS']['FORM_SUBMIT_VARNING'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_FORM_SUBMIT_VARNING'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('EASY_FORM_FORM_SUBMIT_VARNING_DEFAULT'),
        'COLS' => 50,
        'ROWS' => 7,
        'PARENT' => 'PERSONAL_DATA',
    );
...
$arComponentParameters['PARAMETERS']['SEND_AJAX'] = array(
    'NAME' => Loc::getMessage('EASY_FORM_SEND_AJAX'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'Y',
    'PARENT' => 'SUBMIT',
    'REFRESH' => 'Y',
...
if ($arCurrentValues['SEND_AJAX'] != 'N') {
    $arComponentParameters['PARAMETERS']['SHOW_MODAL'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_SHOW_MODAL'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'PARENT' => 'SUBMIT',
        'REFRESH' => 'Y',
    ...
    $arComponentParameters['PARAMETERS']['_CALLBACKS'] = array(
        'PARENT' => 'SUBMIT',
        'NAME' => Loc::getMessage('EASY_FORM_FUNCTION_CALLBACKS_SUCCESS'),
        'TYPE' => 'STRING',
        'DEFAULT' => '',
    );
}
...
if ($arCurrentValues['SHOW_MODAL'] != 'N') {
	$arComponentParameters['PARAMETERS']['TITLE_SHOW_MODAL'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_TITLE_SHOW_MODAL'),
        'TYPE' => 'STRING',
        'DEFAULT' =>  Loc::getMessage('EASY_FORM_DEFAULT_TITLE_SHOW_MODAL'),
        'PARENT' => 'SUBMIT',
    );
}
...
$arComponentParameters['PARAMETERS']['OK_TEXT'] = array(
    'NAME' => Loc::getMessage('EASY_FORM_OK_MESSAGE'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('EASY_FORM_OK_TEXT'),
    'PARENT' => 'SUBMIT',
    'COLS' => 47,
    'ROWS' => 4,
);
$arComponentParameters['PARAMETERS']['ERROR_TEXT'] = array(
    'NAME' => Loc::getMessage('EASY_FORM_ERROR_MESSAGE'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('EASY_FORM_ERROR_TEXT'),
    'PARENT' => 'SUBMIT',
    'COLS' => 47,
    'ROWS' => 4,
);
...
if ($arCurrentValues['USE_IBLOCK_WRITE'] == 'Y' && CModule::IncludeModule('iblock')) {
    ...
    if ($arCurrentValues['CREATE_IBLOCK'] == 'Y' && !array_key_exists('formresult', $arTypesEx)) {
        ...
        $arNewTypeIBFields = Array(
            ...
            'LANG' => Array(
                'ru' => Array(
                    'NAME' => Loc::getMessage('EASY_FORM_IBLOCK_LANG_RU_NAME'),
                    'SECTION_NAME' => '',
                    'ELEMENT_NAME' => ''
                ),
                'en' => Array(
                    'NAME' => Loc::getMessage('EASY_FORM_IBLOCK_LANG_EN_NAME'),
                    'SECTION_NAME' => '',
                    'ELEMENT_NAME' => ''
                )
            )
    ...
    $arComponentParameters['PARAMETERS']['CREATE_IBLOCK'] = array(
        'PARENT' => 'IBLOCK_WRITE',
        'NAME' => Loc::getMessage('EASY_FORM_IBLOCK_PROP_ADD_NAME'),
        'TYPE' => 'CUSTOM',
        'DEFAULT' => '',
        'JS_FILE' => '/bitrix/components/easy/form/lib/settings/button_send_script.js',
        'JS_EVENT' => 'initCreateSendIblock',
        "JS_DATA" => Loc::getMessage('EASY_FORM_CREATE_SEND_IBLOCK_BUTTON'),
    );


    $arComponentParameters['PARAMETERS']['IBLOCK_TYPE'] = array(
        'PARENT' => 'IBLOCK_WRITE',
        'NAME' => Loc::getMessage('EASY_FORM_IBLOCK_DESC_LIST_TYPE'),
        'TYPE' => 'LIST',
        'VALUES' => $arTypesEx,
        'DEFAULT' => 'news',
        'REFRESH' => 'Y',
    ...
    $arComponentParameters['PARAMETERS']['IBLOCK_ID'] = array(
        'PARENT' => 'IBLOCK_WRITE',
        'NAME' => Loc::getMessage('EASY_FORM_IBLOCK_DESC_LIST_ID'),
        'TYPE' => 'LIST',
        'VALUES' => $arIBlocks,
        'DEFAULT' => '',
        'ADDITIONAL_VALUES' => 'Y',
    ...
    if ($arCurrentValues['IBLOCK_ID'] > 0) {
        $arComponentParameters['PARAMETERS']['ACTIVE_ELEMENT'] = Array(
            'PARENT' => 'IBLOCK_WRITE',
            'NAME' => Loc::getMessage('EASY_FORM_ACTIVE_ELEMENT'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'REFRESH' => 'Y',
        );
...
if ($arCurrentValues['USE_CAPTCHA'] == 'Y') {
    ...
    if($includeModuleEasyForm){
        $arComponentParameters["PARAMETERS"]['CUSTOM_FORM'] = array(
            'NAME' => Loc::getMessage('EASY_FORM_CAPTCHA_BUTTON_NAME'),
            "PARENT" => "CAPTCHA",
            'TYPE' => 'CUSTOM',
            ...
            'JS_DATA' => Json::encode(array(
                'LANG' => LANGUAGE_ID,
                'BUTTON_NAME' => Loc::getMessage('EASY_FORM_CAPTCHA_BUTTON_NAME'),
                'COMPONENT_PATH' => $componentPath
            )),
        );
    }else{
        $arComponentParameters['PARAMETERS']['CAPTCHA_KEY'] = array(
            'NAME' => Loc::getMessage('EASY_FORM_CAPTCHA_KEY'),
            'TYPE' => 'STRING',
            'DEFAULT' => '',
            'PARENT' => 'CAPTCHA',
        );
        $arComponentParameters['PARAMETERS']['CAPTCHA_SECRET_KEY'] = array(
            'NAME' => Loc::getMessage('EASY_FORM_CAPTCHA_SECRET_KEY'),
            'TYPE' => 'STRING',
            'DEFAULT' => '',
            'PARENT' => 'CAPTCHA',
        );
    ...
    $arComponentParameters['PARAMETERS']['CAPTCHA_TITLE'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_FIELD_CAPTCHA_TITLE'),
        'TYPE' => 'STRING',
        'DEFAULT' => '',
        'PARENT' => 'CAPTCHA',
    );
...
if (empty($arCurrentValues['ENABLE_SEND_MAIL']) || $arCurrentValues['ENABLE_SEND_MAIL'] != 'N') {
    $arEvent = Array();
    $arFilter = Array('TYPE_ID' => 'EASY_FORM', 'ACTIVE' => 'Y');
    ...
    $arComponentParameters['PARAMETERS']['CREATE_SEND_MAIL'] = array(
        'PARENT' => 'MAIL',
        'NAME' => Loc::getMessage('EASY_FORM_CREATE_SEND_MAIL_BUTTON'),
        'TYPE' => 'CUSTOM',
        'DEFAULT' => '',
        'JS_FILE' => '/bitrix/components/easy/form/lib/settings/button_send_script.js',
        'JS_EVENT' => 'initCreateSendMail',
        "JS_DATA" => Loc::getMessage('EASY_FORM_CREATE_SEND_MAIL'),
    );


    $arComponentParameters['PARAMETERS']['EVENT_MESSAGE_ID'] = array(
        'PARENT' => 'MAIL',
        'NAME' => Loc::getMessage('EASY_FORM_EMAIL_TEMPLATES'),
        'TYPE' => 'LIST',
        'VALUES' => $arEvent,
        'DEFAULT' => '',
        'MULTIPLE' => 'Y',
    ...
    $arComponentParameters['PARAMETERS']['EMAIL_TO'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_EMAIL_TO'),
        'TYPE' => 'STRING',
        'DEFAULT' => '',
        'PARENT' => 'MAIL',
    );
    $arComponentParameters['PARAMETERS']['EMAIL_BCC'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_BCC'),
        'TYPE' => 'STRING',
        'DEFAULT' => '',
        'PARENT' => 'MAIL',
    );
    ...
    $arComponentParameters['PARAMETERS']['MAIL_SUBJECT_ADMIN'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_MAIL_SUBJECT_ADMIN'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('EASY_FORM_MAIL_SUBJECT_ADMIN_DEFAULT'),
        'COLS' => 50,
        'PARENT' => 'MAIL',
    );
    ...
    $arComponentParameters['PARAMETERS']['EMAIL_FILE'] = array(
        'NAME' => Loc::getMessage('EASY_FORM_SEND_EMAIL_FILE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'N',
        'PARENT' => 'MAIL',
    ...
    if(!empty($arCurrentValues['DISPLAY_FIELDS']) && in_array('EMAIL', $arCurrentValues['DISPLAY_FIELDS'])) {
        $arComponentParameters['PARAMETERS']['EMAIL_SEND_FROM'] = array(
            'NAME' => Loc::getMessage('EASY_FORM_SEND_FROM'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'REFRESH' => 'Y',
            'PARENT' => 'MAIL',
        ...
        if($arCurrentValues['EMAIL_SEND_FROM'] == 'Y') {
            ...
            $arComponentParameters['PARAMETERS']['EVENT_MESSAGE_ID_SENDER'] = array(
                'PARENT' => 'MAIL',
                'NAME' => Loc::getMessage('EASY_FORM_EMAIL_TEMPLATES_SENDER'),
                'TYPE' => 'LIST',
                'VALUES' => $arEvent,
                'DEFAULT' => '',
                'MULTIPLE' => 'Y',
        ...
        $arComponentParameters['PARAMETERS']['MAIL_SUBJECT_SENDER'] = array(
            'NAME' => Loc::getMessage('EASY_FORM_MAIL_SUBJECT_SENDER'),
            'TYPE' => 'STRING',
            'DEFAULT' => Loc::getMessage('EASY_FORM_MAIL_SUBJECT_SENDER_DEFAULT'),
            'COLS' => 50,
            'PARENT' => 'MAIL',
        );
        }
...
if (is_array($arFormFields)) {
    ...
    foreach ($arFormFields as $arVal) {
        ...
        $arComponentParameters['GROUPS']['CATEGORY_' . $arVal] = array(
            'NAME' => $fieldName . Loc::getMessage('EASY_FORM_GROUP_FIELD_TITLE'),
            'SORT' => $sort,
        );
        $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_TITLE'] = array(
            'PARENT' => 'CATEGORY_' . $arVal,
            'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_NAME'),
            'TYPE' => 'STRING',
            'DEFAULT' => $fieldName,
        );
        ...
        $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_TYPE'] = array(
            'PARENT' => 'CATEGORY_' . $arVal,
            'NAME' => Loc::getMessage('EASY_FORM_TYPE_FIELD'),
            'TYPE' => 'LIST',
            'VALUES' => array(
                'text' => 'text',
                'email' => 'email',
                ...
                'file' => 'file',
                'checkbox' => 'checkbox',
                'accept' => 'checkbox '.Loc::getMessage('EASY_FORM_TYPE_FIELD_ACCEPT'),
                'radio' => 'radio',
                'url' => 'url',
                'number' => 'number',
                'date' => 'date',
        ...
        $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_VALUE'] = array(
            'PARENT' => 'CATEGORY_' . $arVal,
            'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_VALUE'),
            'TYPE' => 'STRING',
        ...
        if($typeField == "select"){
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_ADD_VAL'] = array(
                'PARENT' => 'CATEGORY_' . $arVal,
                'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_SELECT_ADD'),
                'TYPE' => 'STRING',
                'DEFAULT' => Loc::getMessage('EASY_FORM_GROUP_FIELD_SELECT_ADD_DEF'),
                'ADDITIONAL_VALUES' => 'N',
            ...
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_MULTISELECT'] = array(
                'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_SELECTMULTISELECT_ADD'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'N',
                'REFRESH' => 'Y',
                'PARENT' => 'CATEGORY_' . $arVal,
        ...
        if ($typeField == "checkbox" || $typeField == "radio") {
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_SHOW_INLINE'] = array(
                'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_VIEW'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'Y',
                'REFRESH' => 'N',
                'PARENT' => 'CATEGORY_' . $arVal,
        ...
        if($arCurrentValues['USE_FORMVALIDATION_JS'] != 'N' && $arCurrentValues['HIDE_FORMVALIDATION_TEXT'] != 'Y'){
            if ($isFieldReq == 'Y') {
                $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_VALIDATION_MESSAGE'] = Array(
                    'PARENT' => 'CATEGORY_' . $arVal,
                    'NAME' => Loc::getMessage('EASY_FORM_FIELD_VALIDATION_MESSAGE'),
                    'TYPE' => 'STRING',
                    'DEFAULT' => Loc::getMessage('EASY_FORM_FIELD_VALIDATION_MESSAGE_DEFAULT'),
                );
            }

            $defReqStr = '';
            if ($typeField == 'email') {
                $defReqStr = 'data-bv-emailaddress-message="' . Loc::getMessage('EASY_FORM_FIELD_VALIDATION_MESSAGE_EMAIL_DEFAULT') . '"';
            }
            ...
            if ($typeField != 'hidden' && $typeField != 'file') {
                $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_VALIDATION_ADDITIONALLY_MESSAGE'] = Array(
                    'PARENT' => 'CATEGORY_' . $arVal,
                    'NAME' => Loc::getMessage('EASY_FORM_FIELD_VALIDATION_ADDITIONALLY_MESSAGE'),
                    'TYPE' => 'STRING',
                    'DEFAULT' => $defReqStr
                );
            } else {
        ...
        if ($typeField == 'file') {
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_FILE_EXTENSION'] = array(
                'PARENT' => 'CATEGORY_' . $arVal,
                'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_FILE_EXTENSION'),
                'TYPE' => 'STRING',
            ...
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_FILE_MAX_SIZE'] = array(
                'PARENT' => 'CATEGORY_' . $arVal,
                'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_FILE_MAX_SIZE'),
                'TYPE' => 'INT',
                'DEFAULT' => '20971520', //20Mb
            );

            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_DROPZONE_INCLUDE'] = array(
                'NAME' => Loc::getMessage('EASY_FORM_USE_DROPZONE_JS'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'Y',
                'PARENT' => 'CATEGORY_' . $arVal,
            );
        ...
        if($typeField == 'tel') {
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_INPUTMASK'] = array(
                'NAME' => Loc::getMessage('EASY_FORM_USE_INPUTMASK'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'N',
                'REFRESH' => 'Y',
                'PARENT' => 'CATEGORY_' . $arVal,
            ...
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_INPUTMASK_TEMP'] = Array(
                'PARENT' => 'CATEGORY_' . $arVal,
                'NAME' => Loc::getMessage('EASY_FORM_GROUP_FIELD_INPUTMASK_TEMP'),
                'TYPE' => 'STRING',
        ...
        if ($useWriteIntoIblock) {
            ...
            $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_IBLOCK_FIELD'] = array(
                'PARENT' => 'CATEGORY_' . $arVal,
                'NAME' => Loc::getMessage('EASY_FORM_CATEGORY_IBLOCK_FIELD'),
                'TYPE' => 'LIST',
                'MULTIPLE' => 'N',
                'REFRESH' => 'Y',
                'VALUES' => array_merge(
                    array(
                        'NO_WRITE' => Loc::getMessage('EASY_FORM_IBLOCK_FIELD_NO_WRITE'),
                        'NAME' => Loc::getMessage('EASY_FORM_IBLOCK_FIELD_NAME'),
                        'DETAIL_TEXT' => Loc::getMessage('EASY_FORM_IBLOCK_FIELD_DETAIL_TEXT'),
                        'PREVIEW_TEXT' => Loc::getMessage('EASY_FORM_IBLOCK_FIELD_PREVIEW_TEXT'),
                        'FORM_' . $arVal => Loc::getMessage('EASY_FORM_IBLOCK_FIELD_FORM'),
                    ), $arProperty_LINK),
                'ADDITIONAL_VALUES' => 'N',
	...
	if($mask)
		$arComponentParameters['PARAMETERS']['USE_INPUTMASK_JS'] = array(
			'NAME' => Loc::getMessage('EASY_FORM_USE_INPUTMASK_JS'),
			'TYPE' => 'CHECKBOX',
			'DEFAULT' => 'Y',
			'PARENT' => 'JS_LIB_SETTINGS',
	);
