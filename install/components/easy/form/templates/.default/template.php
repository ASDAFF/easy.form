                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label class="checkbox-inline">
                                    <input  type="checkbox" name="<?=$arField['NAME']?>" value="<?=Loc::getMessage('EASY_FORM_YES')?>" <?=$arField['REQ_STR']?>>&nbsp;<?=htmlspecialcharsBack($arField['VALUE'])?>
                                </label>
                            </div>
                        </div>
                            ...
                            <?if($arField['SET_ADDITION_SELECT_VAL']):?>
                                <div class="form-group switch-child hidden">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            <a href="" class="btn-switch-back" onclick="return false;"><?=Loc::getMessage('EASY_FORM_TO_LIST')?></a>
                                        </div>
                                    </div>
                                </div>
                            <?endif;?>
                ...
                <?if($arParams["USE_CAPTCHA"]):?>
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <? endif; ?>
                            <input id="<?=$FORM_ID?>-captchaValidator"  class="form-control" type="text" required data-bv-notempty-message="<?=GetMessage("EASY_FORM_REQUIRED_MESS");?>" name="captchaValidator" style="border: none; height: 0; padding: 0; visibility: hidden;">
